...
import com.cling.model.message.gena.IncomingSubscribeRequestMessage;
import com.cling.model.message.gena.OutgoingSubscribeResponseMessage;
 ...
 * then creates a new {@link com.cling.model.gena.LocalGENASubscription} if no
