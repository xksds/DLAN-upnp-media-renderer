...
import com.cling.model.action.RemoteActionInvocation;
...
import com.cling.model.message.control.IncomingActionRequestMessage;
import com.cling.model.message.control.OutgoingActionResponseMessage;
import com.cling.model.message.header.ContentTypeHeader;
import com.cling.model.message.header.UpnpHeader;
import com.cling.model.resource.ServiceControlResource;
 ...
 * <p>
 * Actions are invoked through the {@link com.cling.model.action.ActionExecutor} returned
 * by the registered {@link com.cling.model.meta.LocalService#getExecutor(com.cling.model.meta.Action)}
 * method.
 * </p>
 *
