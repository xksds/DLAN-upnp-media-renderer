...
import com.cling.model.message.discovery.OutgoingNotificationRequest;
import com.cling.model.message.discovery.OutgoingNotificationRequestDeviceType;
import com.cling.model.message.discovery.OutgoingNotificationRequestRootDevice;
import com.cling.model.message.discovery.OutgoingNotificationRequestServiceType;
import com.cling.model.message.discovery.OutgoingNotificationRequestUDN;
...
import com.cling.protocol.SendingAsync;
...
public abstract class SendingNotification extends SendingAsync {
    ...
    protected int getBulkRepeat() {
        return 12; // UDA 1.0 says maximum 3 times for alive messages, let's just do it for all
    }
