...
import com.cling.model.message.discovery.OutgoingSearchRequest;
...
public class SendingSearch extends SendingAsync {
    ...
    /**
     * Defaults to {@link com.cling.model.message.header.STAllHeader} and an MX of 3 seconds.
     */
    ...
    public int getBulkRepeat() {
        return 12; // UDA 1.0 says "repeat more than once"
    }

    public int getBulkIntervalMilliseconds() {
        return 3000; // That should be plenty on an ethernet LAN
    }
