...
import com.cling.model.UserConstants;
 ...
 * <p>
 * Uses the {@link com.cling.model.ServiceManager} to read the initial state of
 * the {@link com.cling.model.meta.LocalService} on instantation. Typically, the
 * {@link #registerOnService()} method is called next, and from this point forward all
 * {@link com.cling.model.ServiceManager#EVENTED_STATE_VARIABLES} property change
...
public abstract class LocalGENASubscription extends GENASubscription<LocalService> implements PropertyChangeListener {
    ...
    /**
     * Adds a property change listener on the {@link com.cling.model.ServiceManager}.
     */
    ...
    /**
     * Removes a property change listener on the {@link com.cling.model.ServiceManager}.
     */
    ...
    /**
     * Moderates {@link com.cling.model.ServiceManager#EVENTED_STATE_VARIABLES} events and state variable
