 ...
 * this manager, available with {@link com.cling.model.meta.LocalService#getManager()}:
 * </p>
 * <ul>
 * <li>
 * The {@link com.cling.model.action.ActionExecutor}s use the manager to process
 ...
 * that satisfies the requirements. The {@link com.cling.model.action.ActionExecutor}
 * works in conjuction with the manager, for example, the
 * {@link com.cling.model.action.MethodActionExecutor} expects that an action
 ...
 * the {@link com.cling.model.DefaultServiceManager}. A different service manager
 * might require a different set of action executors, and vice versa.
 * </li>
 * <li>
 * The {@link com.cling.model.state.StateVariableAccessor}s use the manager
 ...
 * {@link com.cling.model.state.StateVariableAccessor} works in conjunction with
 * the service manager, for example, the {@link com.cling.model.state.FieldStateVariableAccessor}
 ...
 * {@link com.cling.model.DefaultServiceManager}. A different service manager
 ...
 *            bound {@link com.cling.model.action.ActionExecutor}s
 *            and {@link com.cling.model.state.StateVariableAccessor}s.
...
public interface ServiceManager<T> {
     ...
     * <p>
     * The service manager will execute the given {@link com.cling.model.Command} and it
     ...
     * @throws Exception Any exception, without wrapping, as thrown by {@link com.cling.model.Command#execute(ServiceManager)}
     */
     ...
     * <li>The "new value" is a <code>Collection</code> of {@link com.cling.model.state.StateVariableValue},
     ...
     *
     * @return A <code>Collection</code> of {@link com.cling.model.state.StateVariableValue}, representing
