...
package com.cling.model.profile;
...
import com.cling.model.message.header.UserAgentHeader;
...
public class RemoteClientInfo extends ClientInfo {
     ...
     * the {@link com.cling.transport.spi.StreamServer} will send meaningless heartbeat
