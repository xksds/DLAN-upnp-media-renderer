 ...
 * }</pre>
 * <p>
 * The namespace is also used to discover and create all {@link com.cling.model.resource.Resource}s
 * given a {@link com.cling.model.meta.Device}'s metadata. This procedure is typically
 * invoked once, when the device is added to the {@link com.cling.registry.Registry}.
 * </p>
 *
