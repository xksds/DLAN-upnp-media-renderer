 ...
 * {@link com.cling.transport.Router} and the {@link com.cling.registry.Registry},
...
public interface UpnpServiceConfiguration {
    ...
    /**
     * @return A new instance of the {@link com.cling.transport.spi.NetworkAddressFactory} interface.
     */
    public NetworkAddressFactory createNetworkAddressFactory();

    /**
     * @return The shared implementation of {@link com.cling.transport.spi.DatagramProcessor}.
     */
    public DatagramProcessor getDatagramProcessor();

    /**
     * @return The shared implementation of {@link com.cling.transport.spi.SOAPActionProcessor}.
     */
    public SOAPActionProcessor getSoapActionProcessor();

    /**
     * @return The shared implementation of {@link com.cling.transport.spi.GENAEventProcessor}.
     */
    public GENAEventProcessor getGenaEventProcessor();

    /**
     * @return A new instance of the {@link com.cling.transport.spi.StreamClient} interface.
     */
    public StreamClient createStreamClient();

    /**
     * @param networkAddressFactory The configured {@link com.cling.transport.spi.NetworkAddressFactory}.
     * @return A new instance of the {@link com.cling.transport.spi.MulticastReceiver} interface.
     */
    public MulticastReceiver createMulticastReceiver(NetworkAddressFactory networkAddressFactory);

    /**
     * @param networkAddressFactory The configured {@link com.cling.transport.spi.NetworkAddressFactory}.
     * @return A new instance of the {@link com.cling.transport.spi.DatagramIO} interface.
     */
    public DatagramIO createDatagramIO(NetworkAddressFactory networkAddressFactory);

    /**
     * @param networkAddressFactory The configured {@link com.cling.transport.spi.NetworkAddressFactory}.
     * @return A new instance of the {@link com.cling.transport.spi.StreamServer} interface.
     */
    ...
    /**
     * @return The shared implementation of {@link com.cling.binding.xml.DeviceDescriptorBinder} for the UPnP 1.0 Device Architecture..
     */
    public DeviceDescriptorBinder getDeviceDescriptorBinderUDA10();

    /**
     * @return The shared implementation of {@link com.cling.binding.xml.ServiceDescriptorBinder} for the UPnP 1.0 Device Architecture..
     */
     ...
     * {@link com.cling.model.meta.DeviceIdentity#maxAgeSeconds} value. Note
     ...
     * {@link com.cling.model.UserConstants#DEFAULT_SUBSCRIPTION_DURATION_SECONDS}
     ...
     * and the default value ({@link com.cling.model.UserConstants#DEFAULT_SUBSCRIPTION_DURATION_SECONDS})
     ...
     * manually remove it from the {@link com.cling.registry.Registry}. You typically remove
     ...
     * HTTP request by Cling. See {@link com.cling.model.profile.ClientInfo} for
    ...
    /**
     * @return An instance of {@link com.cling.model.Namespace} for this UPnP stack.
     */
    ...
    /**
     * Called by the {@link com.cling.UpnpService} on shutdown, useful to e.g. shutdown thread pools.
     */
