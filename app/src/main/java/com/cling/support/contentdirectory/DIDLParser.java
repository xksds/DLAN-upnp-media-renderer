...
package com.cling.support.contentdirectory;

import static com.cling.model.XMLUtil.appendNewElement;
import static com.cling.model.XMLUtil.appendNewElementIfNotNull;

import com.cling.model.types.Datatype;
import com.cling.model.types.InvalidValueException;
import com.cling.support.model.DIDLAttribute;
import com.cling.support.model.DIDLContent;
import com.cling.support.model.DIDLObject;
import com.cling.support.model.DescMeta;
import com.cling.support.model.Person;
import com.cling.support.model.PersonWithRole;
...
import com.cling.support.model.WriteStatus;
 ...
 * </p>
 * <p>
 * Override the {@link #createDescMetaHandler(com.cling.support.model.DescMeta, org.seamless.xml.SAXParser.Handler)}
 * method to read vendor extension content of {@code <desc>} elements. You then should also override the
 * {@link #populateDescMetadata(Element, com.cling.support.model.DescMeta)} method for writing.
 * </p>
 * <p>
 * Override the {@link #createItemHandler(com.cling.support.model.item.Item, org.seamless.xml.SAXParser.Handler)}
...
public class DIDLParser extends SAXParser {
     ...
     * {@link #createDescMetaHandler(com.cling.support.model.DescMeta, org.seamless.xml.SAXParser.Handler)},
     ...
     * {@link com.cling.support.model.DIDLContent#DESC_WRAPPER_NAMESPACE_URI}.
     * </p>
     */
