...
package com.cling.support.connectionmanager;
...
import com.cling.model.types.csv.CSV;
import com.cling.support.connectionmanager.callback.ConnectionComplete;
import com.cling.support.connectionmanager.callback.PrepareForConnection;
...
public abstract class AbstractPeeringConnectionManagerService extends ConnectionManagerService {
     ...
     *
     * @return <code>-1</code> if the {@link #peerFailure(com.cling.model.action.ActionInvocation, com.cling.model.message.UpnpResponse, String)}
     ...
     * management service. The execution of the {@link #createConnectionWithPeer(com.cling.model.ServiceReference, com.cling.controlpoint.ControlPoint, com.cling.model.meta.Service, com.cling.support.model.ProtocolInfo, com.cling.support.model.ConnectionInfo.Direction)}
     * and {@link #closeConnectionWithPeer(com.cling.controlpoint.ControlPoint, com.cling.model.meta.Service, com.cling.support.model.ConnectionInfo)}
