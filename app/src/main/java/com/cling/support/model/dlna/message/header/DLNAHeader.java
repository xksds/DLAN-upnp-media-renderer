 ...
 * <p>
 * The {@link #newInstance(com.cling.support.model.dlna.message.header.DLNAHeader.Type, String)} method
...
public abstract class DLNAHeader<T> extends UpnpHeader<T> {
     ...
     * If no {@link com.cling.model.message.header.InvalidHeaderException} is thrown, the subtype
