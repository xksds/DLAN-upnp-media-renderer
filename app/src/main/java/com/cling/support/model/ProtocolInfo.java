...
/**
 * Encaspulates a MIME type (content format) and transport, protocol, additional
 * information.
 *
...
public class ProtocolInfo {
    ...
    public ProtocolInfo(Protocol protocol, String network,
                        String contentFormat, String additionalInfo) {
    ...
    public String toString() {
        return protocol.toString() + ":" + network + ":" + contentFormat + ":"
                + additionalInfo;
