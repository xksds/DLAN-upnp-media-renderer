...
import com.cling.protocol.ProtocolCreationException;
...
import com.cling.transport.spi.NoNetworkException;
import com.cling.transport.spi.StreamClient;
import com.cling.transport.spi.StreamServer;
import com.cling.transport.spi.UpnpStream;
...
public class RouterImpl implements Router {
    ...
    /**
     * Initializes listening services: First an instance of {@link com.cling.transport.spi.MulticastReceiver}
     * is bound to each network interface. Then an instance of {@link com.cling.transport.spi.DatagramIO} and
     * {@link com.cling.transport.spi.StreamServer} is bound to each bind address returned by the network
     * address factory, respectively. There is only one instance of
     * {@link com.cling.transport.spi.StreamClient} created and managed by this router.
     */
    @Override
     ...
     * by the {@link com.cling.protocol.ProtocolFactory} for the given message.
     * <p>
     ...
     * {@link com.cling.transport.spi.UpnpStream} directly.
     *
     * @param stream The received {@link com.cling.transport.spi.UpnpStream}.
     */
    ...
    /**
     * Sends the UDP datagram on all bound {@link com.cling.transport.spi.DatagramIO}s.
     *
    ...
    /**
     * Sends the TCP stream request with the {@link com.cling.transport.spi.StreamClient}.
     *
     * @param msg The TCP (HTTP) stream message to send.
     * @return The return value of the {@link com.cling.transport.spi.StreamClient#sendRequest(StreamRequestMessage)}
    ...
    /**
     * Sends the given bytes as a broadcast on all bound {@link com.cling.transport.spi.DatagramIO}s,
     * using source port 9.
     * <p>
    ...
    protected void startInterfaceBasedTransports(Iterator<NetworkInterface> interfaces) throws InitializationException {
        while (interfaces.hasNext()) {
            ...
            // Ignore hv0: 192.168.0.3, hv2: 192.168.2.3
            if (networkInterface.getName().equals("hv0") || networkInterface.getName().equals("hv2") || networkInterface.getName().contains("dummy"))
                continue;
    ...
    protected void startAddressBasedTransports(Iterator<InetAddress> addresses) throws InitializationException {
        while (addresses.hasNext()) {
            ...
            // Ignore hv0: 192.168.0.3, hv2: 192.168.2.3
            if (address.getHostName().equals("192.168.0.3") || address.getHostName().equals("192.168.2.3"))
                continue;
