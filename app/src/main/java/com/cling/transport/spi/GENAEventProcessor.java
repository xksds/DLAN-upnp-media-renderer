...
import com.cling.model.message.gena.OutgoingEventRequestMessage;
...
public interface GENAEventProcessor {
    ...
    /**
     * Transforms a collection of {@link com.cling.model.state.StateVariableValue}s into an XML message body.
     *
    ...
    /**
     * Transforms an XML message body and adds to a collection of {@link com.cling.model.state.StateVariableValue}s..
     *
     * @param requestMessage The message to transform.
