 ...
 * {@link com.cling.model.message.IncomingDatagramMessage} and
 * handled by the
 * {@link com.cling.transport.Router#received(com.cling.model.message.IncomingDatagramMessage)}
 * method. This conversion is the job of the {@link com.cling.transport.spi.DatagramProcessor}.
 * </p>
 * <p>
 * Clients of this service use it to send UDP datagrams, either to a unicast
 * or multicast destination. Any {@link com.cling.model.message.OutgoingDatagramMessage} can
 * be converted and written into a datagram with the {@link com.cling.transport.spi.DatagramProcessor}.
 * </p>
 * <p>
...
public interface DatagramIO<C extends DatagramIOConfiguration> extends Runnable {
     ...
     * @param router            The router which handles received {@link com.cling.model.message.IncomingDatagramMessage}s.
    ...
    /**
     * Sends a datagram after conversion with {@link com.cling.transport.spi.DatagramProcessor#write(com.cling.model.message.OutgoingDatagramMessage)}.
     *
