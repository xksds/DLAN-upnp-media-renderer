...
public interface NetworkAddressFactory {
    ...
    public static final String SYSTEM_PROPERTY_NET_IFACES = "com.cling.network.useInterfaces";
    public static final String SYSTEM_PROPERTY_NET_ADDRESSES = "com.cling.network.useAddresses";
