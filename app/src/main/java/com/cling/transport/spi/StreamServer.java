 ...
 * </p>
 * <p>
 * The {@link UpnpStream} then creates a {@link com.cling.model.message.StreamRequestMessage}
 * and calls the {@link UpnpStream#process(com.cling.model.message.StreamRequestMessage)}
...
public interface StreamServer<C extends StreamServerConfiguration> extends Runnable {
     ...
     * @param router      The router which handles the incoming {@link com.cling.transport.spi.UpnpStream}.
     ...
     * {@link #init(InetAddress, com.cling.transport.Router)}, the
