...
import com.cling.model.message.control.ActionRequestMessage;
import com.cling.model.message.control.ActionResponseMessage;

/**
 * Converts UPnP SOAP messages from/to action invocations.
 * <p>
 * The UPnP protocol layer processes local and remote {@link com.cling.model.action.ActionInvocation}
 * instances. The UPnP transport layer accepts and returns {@link com.cling.model.message.StreamRequestMessage}s
 * and {@link com.cling.model.message.StreamResponseMessage}s. This processor is an adapter between the
...
public interface SOAPActionProcessor {
     ...
     * @throws com.cling.model.UnsupportedDataException
     */
