 ...
 * {@link com.cling.transport.Router}. See the pseudo-code example
 * in the documentation of {@link StreamServer}. An implementation's
 * <code>run()</code> method has to call the {@link #process(com.cling.model.message.StreamRequestMessage)},
 * {@link #responseSent(com.cling.model.message.StreamResponseMessage)} and
