...
import com.cling.transport.spi.StreamServerConfiguration;

/**
 * Settings for the async Servlet 3.0 implementation.
 * <p>
 * If you are trying to integrate Cling with an existing/running servlet
 * container, implement {@link com.cling.transport.spi.ServletContainerAdapter}.
 * </p>
 *
...
public class AsyncServletStreamServerConfigurationImpl implements StreamServerConfiguration {
    ...
    /**
     * The time in seconds this server wait for the {@link com.cling.transport.Router}
     * to execute a {@link com.cling.transport.spi.UpnpStream}.
     *
