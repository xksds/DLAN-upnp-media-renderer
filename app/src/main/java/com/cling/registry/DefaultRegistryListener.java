 ...
 * {@link #deviceAdded(Registry, com.cling.model.meta.Device)} and
 * {@link #deviceRemoved(Registry, com.cling.model.meta.Device)} methods.
 * </p>
 *
...
public class DefaultRegistryListener implements RegistryListener {
    ...
    /**
     * Calls the {@link #deviceAdded(Registry, com.cling.model.meta.Device)} method.
     *
    ...
    /**
     * Calls the {@link #deviceRemoved(Registry, com.cling.model.meta.Device)} method.
     *
     * @param registry The Cling registry of all devices and services know to the local UPnP stack.
     * @param device   A validated and hydrated device metadata graph, with complete service metadata.
     */
