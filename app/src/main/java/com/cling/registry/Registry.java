...
public interface Registry {
     ...
     * end with {@link com.cling.model.gena.CancelReason#RENEWAL_FAILED}. Although
    ...
    /**
     * @param <T>          The required subtype of the {@link com.cling.model.resource.Resource}.
     * @param pathQuery    The path and optional query string of the resource's
     *                     registration URI (e.g. <code>/dev/somefile.xml?param=value</code>)
     * @param resourceType The required subtype of the {@link com.cling.model.resource.Resource}.
